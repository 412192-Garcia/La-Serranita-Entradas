...
public enum FormaPago {
    ...
    RESERVA_ADMIN("Reserva generada", "Reserva cargada a mano por un administrador, sin cobrar nada por acá — el cobro, si lo hay, se resolvió por fuera (ej. invitados, ventas por agencia)"),
